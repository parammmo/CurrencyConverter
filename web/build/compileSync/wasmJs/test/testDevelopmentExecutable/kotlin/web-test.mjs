...
import { importObject, setWasmExports } from './web-test.import-object.mjs'
...
const wasmFilePath = './web-test.wasm';
...
try {
  ...
  if (isBrowser) {
    wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./web-test.wasm',import.meta.url).href), importObject, wasmOptions)).instance;
  }
} catch (e) {
