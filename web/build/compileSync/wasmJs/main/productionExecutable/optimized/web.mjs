...
import { importObject, setWasmExports } from './web.import-object.mjs'
...
try {
  ...
  if (isBrowser) {
    wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./web.wasm',import.meta.url).href), importObject, wasmOptions)).instance;
  }
} catch (e) {
